...
ThemeData dark = ThemeData(
  ...
  primaryColor: const Color(0xFF4eb7b2),
  ...
  colorScheme: const ColorScheme.dark(
    primary: Color(0xFF4eb7b2),
    secondary: Color(0xFF4eb7b2),
    ...
    outline: Color(0xff028A81),
    onTertiary: Color(0xFF545252),
    secondaryContainer: Color(0xFFF2F2F2),
  ),
  textTheme: const TextTheme(bodyLarge: TextStyle(color: Color(0xFF4eb7b2))),
